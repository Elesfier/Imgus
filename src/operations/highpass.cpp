...
//
// 8.2 Filtry Górnoprzepustowe
//
namespace Operations
{
  class Highpass  : public Operation
  {
  public:

    Highpass()
    {
      name = "Filtr Górnoprzepustowy";
      fileExt = "_Filtr_Gornoprzepustowy_";
      disableBinary = true;
    }

    void operate(Image::Image *img, Operations::ParamsPack params)
    {
      double highpassKernel[9] = {-1.0, -1.0, -1.0, -1.0, 9.0, -1.0, -1.0, -1.0, -1.0};
